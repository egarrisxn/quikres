...
import { NavigationMenuLink as NavigationMenuPrimitiveLink } from "@radix-ui/react-navigation-menu";
import { cva } from "class-variance-authority";
import { ChevronDown } from "lucide-react";
import { cn } from "@/lib/utils";

interface NavigationMenuListItemProps extends React.ComponentProps<"li"> {
  title: string;
...
function NavigationMenuList({
  ...
  return (
    <NavigationMenuPrimitive.List
      ...
      className={cn(
        "group font-base flex flex-1 list-none items-center justify-center space-x-1",
        className
      )}
      {...props}
    />
