...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "rounded-base! border-border bg-primary font-heading shadow-base border-2 p-3",
        className
      )}
      classNames={{
        ...
        day_outside:
          "day-outside text-primary-foreground opacity-50 aria-selected:bg-none",
        day_disabled: "text-primary-foreground opacity-50 rounded-base",
